...
bool Test16BitFloatingPointBlend(bool verbose) {
  ...
  mo->GetProperty(PointSetModelObject::NUMBER_OF_POINTS_PROP)->SetIntValue(2047);
  mo->Update();
  ...
  // Set the gain to produce an image with max intensity 2047
  double gain2047 = 2047.0 / range[1];
  fluoroSim->SetGain(gain2047);
